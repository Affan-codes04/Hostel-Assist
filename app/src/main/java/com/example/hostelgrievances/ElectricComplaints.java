...
public class ElectricComplaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_complaints);
...
/*
    ...
    public void raise(View v){
        ...
        DatabaseReference df = FirebaseDatabase.getInstance().getReference("Electricity Issue").child(registerNumber);
