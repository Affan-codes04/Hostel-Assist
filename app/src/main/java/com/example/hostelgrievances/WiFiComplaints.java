...
public class WiFiComplaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wi_fi_complaints);
...
/*
    ...
    public void raise(View v){
        ...
        // Use registerNumber as the key for this complaint
        DatabaseReference df = FirebaseDatabase.getInstance().getReference("WiFi Issue").child(registerNumber);
